...
Go to link:hotadd_drive_shelf_task.md#[Install the drive shelf].
...
Go to link:hotadd_drive_shelf_task.md#[Cable your system].
...
Go to link:hotadd_drive_shelf_task.md#[Complete hot add].
