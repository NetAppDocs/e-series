...
---
= Cabling your storage system - E-Series
:icons: font
:imagesdir: ../media/
...
NOTE: If you do not see your controller shelf (storage system) listed below, see link:../getting-started/getup-run-concept.html[Quick start for E-Series^] and click the link for your specific storage system to access the cabling information.
...
If you are cabling for any of the following configurations, see https://mysupport.netapp.com/ecm/ecm_download_file/ECMLP2859057[Adding IOM Drive Shelves to an Existing E27XX, E56XX, or EF560 Controller Shelf.^]
...
For information about cabling to support mirroring features, see the https://www.netapp.com/pdf.html?item=/media/17069-tr4656pdf.pdf[Synchronous and Asynchronous Mirroring Feature Descriptions and Deployment Guide^].
