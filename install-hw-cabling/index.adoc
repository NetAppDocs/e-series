...
For information about cabling to support mirroring features, see the https://www.netapp.com/pdf.html?item=/media/19405-tr-4839.pdf[Synchronous and Asynchronous Mirroring Feature Descriptions and Deployment Guide^].
