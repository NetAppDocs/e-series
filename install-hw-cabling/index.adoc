...
If you do not see your controller shelf (storage system) listed below, see link:../getting-started/getup-run-concept.html[Quick start for E-Series^] and click the link for your specific storage system to access the cabling information.
