...
For information about cabling to support mirroring features, see the https://www.netapp.com/pdf.html?item=/media/17133-tr4656.pdf[Synchronous and Asynchronous Mirroring Feature Descriptions and Deployment Guide^].
