...
image::../media/12_24_cabling.png["12-drive and 24-drive shelf cabling"]
...
image::../media/60_cabling.png["60-drive shelf cabling"]
...
image::../media/ef_to_de224c_four_shelves.png["12-drive and 24-drive shelf cabling"]
...
image::../media/ef_to_de460c.png["60-drive shelf cabling"]
