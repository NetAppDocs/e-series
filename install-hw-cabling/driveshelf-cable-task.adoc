...
* If you are cabling an EF50 or EF80 storage system to external SAS shelves as part of a new system installation, see link:../install-hw-ef50-ef80/install-cable.html[Cable the hardware - EF50 and EF80] procedure.
