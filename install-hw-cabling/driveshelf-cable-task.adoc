...
* If you are cabling an EF50 or EF80 storage system to SAS expansion shelves as part of a new system installation, see link:../install-hw-ef50-ef80/install-cable.html[Cable the hardware - EF50 and EF80] procedure.
...
// Aug 2026: updated to redirect for SAS expansion content for 12.10 release.