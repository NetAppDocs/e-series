...
For host cabling specific to your storage system, see link:../getting-started/getup-run-concept.html[Quick start for E-Series^] and click the link for your specific storage system.
