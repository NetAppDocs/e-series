...
. Power on both power supplies.
+
NOTE: Depending on your storage system, the power supplies have power switches or there are no power switches and you must connect the power cables to power them on.
