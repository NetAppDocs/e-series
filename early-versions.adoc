...
= E-Series hardware and SANtricity software - Earlier versions
:icons: font
:imagesdir: ./media/
...
* https://docs.netapp.com/us-en/e-series-santricity-119/index.html[System Manager help^]
* https://docs.netapp.com/us-en/e-series-santricity-119/index.html[Unified Manager help^]
