---
permalink: maintenance-ef50-ef80/io-module-convert-protocol.html
sidebar: sidebar
...
NOTE: You cannot access data on the storage system until you successfully complete the conversion.
...
After you've changed the host protocol, you need to link:io-module-convert-protocol-complete.html[Complete the host protocol conversion].
