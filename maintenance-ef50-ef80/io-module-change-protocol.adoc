...
You can change the protocol on the host I/O modules in your EF50 or EF80 storage system as part of an I/O module upgrade or when the default protocol on new controllers part of a new storage system installation or controller upgrade is not the protocol you want.


.Before you begin

You need to have completed the applicable hardware procedure (I/O module upgrade, new system installation, or controller upgrade).
