...
* Make sure that the I/O modules you are upgrading to are supported by your storage system, that you have the same type and number of I/O modules for each controller, and that you understand the slot priority.
+
...
.Steps
. If you are not already grounded, properly ground yourself.
. On one of the controllers, remove the I/O blanking module from the target slot.
+
