...
summary: You can upgrade I/O modules in your EF50 or EF80 storage system to increase the number of host ports for enhanced network connectivity, expand your system’s ability to handle data traffic, and connect SAS expansion shelves.
---
...
[.lead]
You can upgrade I/O modules in your EF50 or EF80 storage system to increase the number of host ports for enhanced network connectivity, expand your system’s ability to handle data traffic, and connect SAS expansion shelves. 
...
Prepare to upgrade I/O modules by scheduling a downtime maintenance window, updating the firmware, gathering the necessary tools and equipment, and backing up the storage system's configuration database.
...
Power on both controllers, check that communication between the controllers is reestablished, and then confirm the controllers are functioning properly.
...
The process of upgrading I/O modules to your storage system is complete. You can resume normal operations.
