...
[.lead]
You can upgrade the I/O modules in your EF50 or EF80 storage system to increase the number of host ports.

From gO:You can upgrade the I/O module to your EF50 or EF80 storage system to enhance network connectivity and expand your system’s ability to handle data traffic.
