---
permalink: config-linux/ib_assign_volume_nvme_task.html
sidebar: sidebar
keywords: assign, volume, namespace, host, cluster, i/o, operation, assignment, grant, access, storage, array
