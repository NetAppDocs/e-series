---
permalink: config-linux/nvme-tcp-access-sam-setup-wizard-task.html
sidebar: sidebar
...
---
= Configure your storage using SANtricity System Manager - Linux (NVMe over TCP)
:experimental:
:icons: font
:imagesdir: ../media/
...
.What's next?
After you configure the storage in SANtricity System Manager, link:nvme-tcp-configure-switch-task.html[configure the switches].
