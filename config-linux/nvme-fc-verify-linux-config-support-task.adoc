...
---
= Verify Linux configuration support and review restrictions in E-Series (NVMe over FC)
:experimental:
:icons: font
:imagesdir: ../media/
...
Before using NVMe over Fibre Channel, see the https://mysupport.netapp.com/matrix[NetApp Interoperability Matrix Tool^] to review the latest controller, host, and recovery restrictions.
