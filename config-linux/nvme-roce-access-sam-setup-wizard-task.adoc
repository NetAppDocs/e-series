...
---
= Configure your storage using SANtricity System Manager - Linux (NVMe over RoCE)
:experimental:
:icons: font
:imagesdir: ../media/
...
.What's next?
After you configure the storage in SANtricity System Manager, link:nvme-roce-configure-switch-task.html[configure the switches].
