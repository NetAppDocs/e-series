...
.About this task
The following procedure is for RHEL 8, RHEL 9, SLES 12, and SLES 15 using Broadcom Emulex or QLogic NVMe/FC capable FC HBAs. For more information on which versions of these OS’s or HBA’s are supported, consult the https://mysupport.netapp.com/matrix[NetApp Interoperability Matrix Tool^].
