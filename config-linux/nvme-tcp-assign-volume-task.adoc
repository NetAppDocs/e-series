---
permalink: config-linux/nvme-tcp-assign-volume-task.html
sidebar: sidebar
...
---
= Assign a volume using SANtricity System Manager - Linux (NVMe over TCP)
:experimental:
:icons: font
:imagesdir: ../media/
...
. From the left panel of the SANtricity System Manager interface, select menu:Storage[Hosts].
...
.What's next?
After you assign a volume, link:nvme-tcp-display-volumes-visible-host-task.html[display the visible volumes to the host].
