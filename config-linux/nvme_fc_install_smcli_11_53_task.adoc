---
permalink: config-linux/nvme_fc_install_smcli_11_53_task.html
sidebar: sidebar
keywords: install, santricity, storage, manager, management, station, graphical, user, interface, gui, command, line, default, instruction, i/o, host, smcli
