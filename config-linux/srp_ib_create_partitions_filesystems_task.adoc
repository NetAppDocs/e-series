---
permalink: config-linux/srp_ib_create_partitions_filesystems_task.html
sidebar: sidebar
keywords: lun, partition, file, system, linux, host, discover, format, lun, filesystem, create
