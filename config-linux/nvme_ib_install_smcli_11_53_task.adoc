---
permalink: config-linux/nvme_ib_install_smcli_11_53_task.html
sidebar: sidebar
keywords: install, santricity, storage, manager, software, management, station, graphical, user, interface, gui, command, line, cli, default, instruction, i/o, host, smcli
