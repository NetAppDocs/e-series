...
summary: For SLES 12, you create a file system on the namespace and mount the filesystem.
---
= Create filesystems in E-Series - Linux SLES 12 (NVMe over InfiniBand)
:icons: font
:imagesdir: ../media/
