...
---
= Create filesystems in E-Series - Linux RHEL 8, RHEL 9, and SLES 15 (NVMe over InfiniBand)
:icons: font
:imagesdir: ../media/
...
----
+
The result of this command can be used to find the devices associated with the `/dev/disk/by-id/nvme-eui.[uuid#]` location. For the example below, this would be `/dev/disc/by-id/nvme-eui.000082dd5c05d39300a0980000a52225`.
+
----
