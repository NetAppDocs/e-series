---
permalink: config-linux/iser_ib_configure_multipath_software_task.html
sidebar: sidebar
keywords: multipath, software, provide, redundant, path, storage, array, physical, disrupt, single, virtual, device, failover, mapper, dm-mp, tool, linux, installation
