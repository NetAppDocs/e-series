...
summary: Use the SMdevices tool, part of the nvme-cli package, SMcli, to view the volumes currently visible on the host. This is an alternative to the nvme list command.
---
