---
permalink: config-linux/srp_ib_configure_multipath_software_task.html
sidebar: sidebar
keywords: multipath, software, redundant, path, storage, array, physical, path, disrupt, failover, process, update, virtual, device, mapper, map, dm-mp, tool, linux, installation, configure
