...
. Verify that you can ping from the host to each array HIC port using your expected MTU rate using the following command:
+
----
...
.What's next?
After you establish the connections, link:nvme-roce-define-host-task.html[define the host].