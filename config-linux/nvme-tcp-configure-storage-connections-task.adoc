...
NOTE: The configured NVMe over TCP port speed should match the speed capability of the SFP on the selected port. All ports must be set to the same speed.
a|
