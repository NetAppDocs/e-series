---
permalink: config-linux/nvme-tcp-display-volumes-visible-host-task.html
sidebar: sidebar
...
---
= Display the volumes visible to the host in E-Series - Linux (NVMe over TCP)
:icons: font
:imagesdir: ../media/
...
.What's next?
After you view the visible volumes, link:nvme-tcp-setup-failover-host-task.html[set up failover on the host].
