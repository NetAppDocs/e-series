...
---
= Configure IP addresses using DHCP in E-Series - Linux (NVMe over RoCE)
:icons: font
:imagesdir: ../media/
...
.What's next?
After you configure the IP addresses using DHCP, link:nvme-roce-access-sam-setup-wizard-task.html[configure your storage using SANtricity System Manager].
