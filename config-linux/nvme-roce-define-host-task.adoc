...
---
= Create a host using SANtricity System Manager - Linux (NVMe over RoCE)
:experimental:
:icons: font
:imagesdir: ../media/
...
.What's next?
After you create the host, link:nvme-roce-assign-volume-task.html[assign a volume through SANtricity System Manager].
