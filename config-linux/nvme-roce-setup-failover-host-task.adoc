...
.What's next?
With the native NVMe Multipathing enabled, link:nvme-roce-access-physical-targets-concept.html[access the NVMe volumes for an E-Series target from the host].
