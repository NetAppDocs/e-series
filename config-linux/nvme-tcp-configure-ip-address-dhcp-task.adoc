---
permalink: config-linux/nvme-tcp-configure-ip-address-dhcp-task.html
sidebar: sidebar
...
---
= Configure IP addresses using DHCP in E-Series - Linux (NVMe over TCP)
:icons: font
:imagesdir: ../media/
...
.What's next?
After you configure the IP addresses using DHCP, link:nvme-tcp-access-sam-setup-wizard-task.html[configure your storage using SANtricity System Manager].
