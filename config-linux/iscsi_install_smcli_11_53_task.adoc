---
permalink: config-linux/iscsi_install_smcli_11_53_task.html
sidebar: sidebar
keywords: install, santricity, storage, manager, software, station, management, command, line, interface, cli, host, i/o, path, controller
