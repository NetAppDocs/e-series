...
.What's next?
After you set up the NVMe over TCP initiator on the host, link:nvme-tcp-configure-storage-connections-task.html[configure the NVMe over TCP port settings].
