...
. If you are using the inbox ethernet driver for your HCA, install the `nvme-cli` package as follows:
+
*SLES 15 or SLES 16*
+
----
...
----
+
If you are using an NVIDIA HCA and wish to use the external DOCA driver, please refer to the link:https://developer.nvidia.com/doca-downloads[NVIDIA documentation] for information how to properly install it in this environment.
