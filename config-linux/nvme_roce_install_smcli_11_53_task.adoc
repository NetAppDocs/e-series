---
permalink: config-linux/nvme_roce_install_smcli_11_53_task.html
sidebar: sidebar
keywords: install, santricity, storage, manager, software, station, graphical, user, interface, gui, command, line, cli, default, instruction, management, i/o, host, smcli, version
