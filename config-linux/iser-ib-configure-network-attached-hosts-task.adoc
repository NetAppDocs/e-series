...
+
*Red Hat Enterprise Linux 8 and 9 (RHEL 8 and RHEL 9)*
+
----
...
----
 ...
 .. Check the iscsi session status from the array. From SANtricity System Manager, navigate to *Settings* > *System* > *View/End iSCSISessions*.
