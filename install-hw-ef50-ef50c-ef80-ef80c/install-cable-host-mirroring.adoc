---
permalink: install-hw-ef50-ef50c-ef80-ef80c/install-cable-host-mirroring.html
sidebar: sidebar
keywords: 
summary: Cable the controller shelf's mirroring and data host network connections.
---
...
[.lead]
Cable the controller shelf's mirroring and data host network connections.
