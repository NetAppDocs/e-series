...
sidebar: sidebar
keywords: 
summary: Cable and configure the controllers management connections, and complete storage system setup and configuration.
---
= Complete storage system setup - EF50, EF50C, EF80, EF80C
:icons: font
:imagesdir: ../media/

[.lead]
Cable and configure the controllers management connections, and complete storage system setup and configuration.
