...
[.lead]
Cable and configure the controllers management connections, and complete storage system setup and configuration for your EF50, EF50C, EF80, or EF80C storage system.



== Step 1: Connect and configure the management connection
...
== Step 2: Configure and manage your storage system

Use the SANtricity software to configure and manage your storage system.
