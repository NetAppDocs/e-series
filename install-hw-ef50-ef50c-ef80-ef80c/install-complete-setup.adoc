...
[.lead]
Cable and configure the controller management port on each controller for out-of-band storage system management, and then configure your EF50, EF50C, EF80, or EF80C storage system.
...
+
image:../media/drw_ef50-ef50c-ef80-ef80c_wrench_to_network_ieops-2613.svg[ef50 ef50c ef80 ef80c controller management port cabling to network]
...
. Connect either controller to a web browser.
