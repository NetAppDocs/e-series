...
[.lead]
Cable and configure the controller management ports, and then complete storage system setup and configuration for your EF50, EF50C, EF80, or EF80C storage system.
...
* Cable and configure your controller management ports.
