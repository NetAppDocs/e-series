...
sidebar: sidebar
keywords: 
summary: Learn how to install a EF50, EF50C, EF80, or EF80C storage system in a two-post rack or a NetApp system cabinet.
---
...
[.lead]
After you prepare to install your EF50, EF50C, EF80, or EF80C storage system, install the hardware for the storage system. First, install the rail kits. Then install and secure your storage system in a cabinet or telco rack.

Learn how to install an EF50, EF50C, EF80, or EF80C storage system in a two-post rack or a NetApp system cabinet.
