---
permalink: install-hw-ef50-ef50c-ef80-ef80c/install-hardware-12.html
sidebar: sidebar
keywords: 
summary: Learn how to install a E4012, DE212C, or DE224C storage system in a two-post rack or a NetApp system cabinet.
---
= Install the hardware  - E4012
:icons: font
:imagesdir: ../media/

[.lead]
Learn how to install an E4012 or DE212C storage system in a two-post rack or a NetApp system cabinet.
