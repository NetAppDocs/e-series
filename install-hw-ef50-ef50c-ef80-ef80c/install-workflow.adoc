...
---
= Install and setup - EF50, EF50C, EF80, and EF80C storage systems
:icons: font
:imagesdir: ../media/

[.lead]
Follow these steps to install and set up you EF50, EF50C, EF80, or EF80C storage system.

.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-1.png[One] Prepare for installation

[role="quick-margin-para"]
You must prepare your site to meet the specifications for your EF50, EF50C, EF80, and EF80C storage systems.
