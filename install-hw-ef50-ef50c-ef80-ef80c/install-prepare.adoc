...
[.lead]
Prepare to install your EF50, EF50C, EF80, or EF80C storage system by getting the site ready, understanding the lifting precautions for your storage systemunpacking the boxes and comparing the contents to the packing slip, and registering the storage system to access support benefits.
