...
summary: Attach the power cables and power on the drive shelves for your EF50, EF50C, EF80, or EF80C storage system.
---
= Connect the power cables - EF50, EF50C, EF80, and EF80C
:icons: font
:imagesdir: ../media/
