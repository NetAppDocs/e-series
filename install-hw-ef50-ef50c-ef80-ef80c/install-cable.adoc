...
.About this task
The cabling example shows data host I/O modules in slots 1, 2, and 3 - the maximum number of data host I/O modules supported for the EF80 and EF80C storage systems. However, only the data host I/O module in slot 1 is required; data host I/O modules in slot 2 and slot 3 are both optional.
...
.About this task
The cabling example shows data host I/O modules in slots 1 and 2 - the maximum number of data host I/O modules supported for the EF50 and EF50C storage systems. However, only the data host I/O module in slot 1 is required; the data host I/O module in slot 2 is optional.
