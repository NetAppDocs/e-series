...
[.lead]
After you install your EF50 or EF80 storage system hardware, cable the mirroring and host network connections for the controllers.
...
.EF50 with three 4-port 64Gb FC I/O modules
[%collapsible]
====
