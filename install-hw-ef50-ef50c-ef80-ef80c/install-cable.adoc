...
. Cable the data host connections:
.. Cable Controller A port exx to host 1.
.. Cable Controller A port exx to host 2
.. Cable Controller B port exx to host 1.
.. Cable Controller B port exx to host 2.
...
. Cable Controller A port exx to switch 1.
. Cable Controller A port exx to switch 2.
. Cable Controller B port exx to switch 1.
. Cable Controller B port exx to switch 2.
