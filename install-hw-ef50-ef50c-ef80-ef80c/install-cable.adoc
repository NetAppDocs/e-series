...
sidebar: sidebar
keywords: 
summary: Cable the mirroring and data host network connections for your EF50, EF50C, EF80, or EF80C storage system.
---
...
[.lead]
Cable the mirroring and data host network connections for your EF50, EF50C, EF80, or EF80C storage system.
...
== Step 3: Connect and configure the management connection
...
== Step 4: Configure and manage your storage system
