...
** Each switch (Switch A and Switch B) has one cable connection to the cluster of blue or red cabling to the HICs on each controller. These connections make a total of 12 connections for the blue and for the red cabling.
*** Switch 1 (blue cabling) connects to the cluster of cabling that is cabled to 'a' and 'c' ports on each host HIC.
*** Switch 2 (red cabling) connects to the cluster of cabling that is cabled to 'b' and 'd' ports on each host HIC.
