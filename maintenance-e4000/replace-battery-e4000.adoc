...
. Confirm that the Cache Active LED on the back of the controller and the controller faceplate is off.
+
If either LED is on, the controller is still using battery power. They must be off before you continue with this procedure.
