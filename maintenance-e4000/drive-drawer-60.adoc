...
. If you performed the drive drawer replacement procedure online, and if any drives in the replacement drawer are failed after you completed the procedure, you must reconstruct the drives manually.
+
