...
summary: You can replace a drive drawer in an E4060 controller shelf or a DE460C drive shelf.
---
= Replace the drive drawer - E4000 (60-drive shelf)
:experimental:
:icons: font
:imagesdir: ../media/
...
. From the left panel of SANtricity System Manager, select menu:Storage[Operations in Progress].
