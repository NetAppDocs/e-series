...
. From the home page of SANtricity System Manager, select menu:Storage [Operations in Progress].
...
.. Select *Storage › Volumes*. From the *All Volumes* page, verify that volumes are distributed to their preferred owners. Select *ellipse icon › Change ownership* to view volume owners.
