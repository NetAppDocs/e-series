...
---
= Verify storage access on a Windows host in E-Series
:icons: font
:imagesdir: ../media/
...
. To verify that multipath is working, change the volume ownership.
 .. From the SANtricity System Manager, go to *Storage* > *Volumes*, and then select the *ellipsis icon* > *Change volume ownership*.
