---
permalink: config-windows/overview_concept.html
sidebar: sidebar
keywords: express, method, install, storage, array, access, santricity, system, manager, set, up, standalone, windows, host, e-series, minimal, decision, point
summary: The Windows express method for installing your storage array and accessing SANtricity System Manager is appropriate for setting up a standalone Windows host to an E-Series storage system. It is designed to get the storage system up and running as quickly as possible with minimal decision points.
---
= Assumptions
:icons: font
:imagesdir: ../media/
