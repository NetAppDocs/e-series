...
---
= Replace a drive in an EF300 array
:icons: font
:imagesdir: ../media/

[.lead]
You can replace a drive in an EF300 or EF300C array.

The EF300 and EF300C supports SAS expansion with 24-drive and 60-drive shelves. The procedure you follow depends on whether you have a 24-drive shelf or a 60-drive shelf:
