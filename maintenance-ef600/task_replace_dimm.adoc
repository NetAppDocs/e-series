---
permalink: maintenance-ef600/task_replace_dimm.html
sidebar: sidebar
keywords: 
summary: ''
---
...
Go to link:task_replace_dimm.md#[Place controller offline].
...
Go to link:task_replace_dimm.md#[Remove controller canister].
...
Go to link:task_replace_dimm.md#[Remove DIMMs].
...
Go to link:task_replace_dimm.md#[Install new DIMMs].
...
Go to link:task_replace_dimm.md#[Reinstall controller canister].
...
Go to link:task_replace_dimm.md#[Complete DIMMs replacement].
