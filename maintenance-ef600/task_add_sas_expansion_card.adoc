---
permalink: maintenance-ef600/task_add_sas_expansion_card.html
sidebar: sidebar
keywords: 
summary: ''
---
...
Go to link:task_add_sas_expansion_card.md#[Remove controller canister]
...
Go to link:task_add_sas_expansion_card.md#[Add the new SAS expansion card].

== Add the new SAS expansion card
...
Go to link:task_add_sas_expansion_card.md#[Reinstall the controller canister].
...
Go to link:task_add_sas_expansion_card.md#[Complete adding SAS expansion card].

== Complete adding SAS expansion card
