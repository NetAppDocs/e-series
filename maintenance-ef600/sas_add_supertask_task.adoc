...
Go to link:sas_add_supertask_task.md#[Remove controller canister]
...
Go to link:sas_add_supertask_task.md#[Add the new SAS expansion card].
...
Go to link:sas_add_supertask_task.md#[Reinstall the controller canister].
...
Go to link:sas_add_supertask_task.md#[Complete adding SAS expansion card].
