---
permalink: maintenance-ef600/task_replace_a_failed_host_interface_card.html
sidebar: sidebar
keywords: 
summary: ''
---
...
Go to link:task_replace_a_failed_host_interface_card.md#[Remove controller canister].
...
Go to link:task_replace_a_failed_host_interface_card.md#[Remove the host interface card].
...
Go to link:task_replace_a_failed_host_interface_card.md#[Replace host interface card].
...
Go to link:task_replace_a_failed_host_interface_card.md#[Reinstall controller canister]
...
Go to link:task_replace_a_failed_host_interface_card.md#[Complete host interface card replacement].
