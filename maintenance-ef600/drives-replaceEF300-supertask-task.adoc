...
---
= Replace drive in an EF300
:icons: font
:imagesdir: ../media/

[.lead]
Follow this procedure to replace a drive in an EF300 shelf.

.About this task

The EF300 shelf supports SAS expansion with 24-drive and 60-drive shelves.
