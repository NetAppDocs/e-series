...
Go to link:hics_replace_supertask_task.md#[Remove controller canister].
...
Go to link:hics_replace_supertask_task.md#[Remove the host interface card].
...
Go to link:hics_replace_supertask_task.md#[Replace host interface card].
...
Go to link:hics_replace_supertask_task.md#[Reinstall controller canister]
...
Go to link:hics_replace_supertask_task.md#[Complete host interface card replacement].
