...
Go to link:hics_add_supertask_task.md#[Remove controller canister]
...
Go to link:hics_add_supertask_task.md#[Add the new host interface card].
...
Go to link:hics_add_supertask_task.md#[Reinstall the controller canister].
...
Go to link:hics_add_supertask_task.md#[Complete adding host interface card].
