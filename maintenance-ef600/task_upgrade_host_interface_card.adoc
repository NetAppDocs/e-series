---
permalink: maintenance-ef600/task_upgrade_host_interface_card.html
sidebar: sidebar
keywords: 
summary: ''
---
...
Go to link:task_upgrade_host_interface_card.md#[Remove controller canister]
...
Go to link:task_upgrade_host_interface_card.md#[Remove a host interface card].
...
Go to link:task_upgrade_host_interface_card.md#[Upgrade host interface card].
...
Go to link:task_upgrade_host_interface_card.md#[Reinstall controller canister].
...
Go to link:task_upgrade_host_interface_card.md#[Complete the host interface card upgrade].
