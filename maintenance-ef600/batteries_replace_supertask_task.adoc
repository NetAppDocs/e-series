---
permalink: maintenance-ef600/batteries_replace_supertask_task.html
sidebar: sidebar
keywords: controller, canister, battery, preserve, cache, data, ac, power, fail, recovery, guru, santricity, system, manager, report, status, replacement, status, place, offline, remove, install, reinstall, complete
...
Go to link:batteries_replace_supertask_task.md#[Remove controller canister].
...
Go to link:batteries_replace_supertask_task.md#[Remove failed battery].
...
Go to link:batteries_replace_supertask_task.md#[Install new battery].
...
Go to link:batteries_replace_supertask_task.md#[Reinstall controller canister].
...
Go to link:batteries_replace_supertask_task.md#[Complete battery replacement].
