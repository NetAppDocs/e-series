...
Go to link:maintenace-ef600/controllers_replace_supertask_task.html[Remove host interface card].
...
Go to link:maintenance-ef600/controllers_replace_supertask_task.html[Remove fans]
...
Go to link:maintenance-ef600/controllers_replace_supertask_task.html[Install Fans]
...
Go to link:maintenance-ef600/controllers_replace_supertask_task.html[Install new controller canister]
