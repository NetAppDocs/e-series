---
permalink: maintenance-ef600/drives_replace_supertask_task.html
sidebar: sidebar
keywords: recovery, guru, santricity, system, manager, monitor, drive, storage, array, notify, impend, fail, amber, attention, led, hot-swap, i/o, prepare, replace, remove, complete, replacement
...
Go to link:drives_replace_supertask_task.md#[Remove drive].
...
* You have reviewed link:drives_overview_supertask_concept.md#[Requirements for replacing drives].
...
Go to link:drives_replace_supertask_task.md#[Install new drive].
...
Go to link:drives_replace_supertask_task.md#[Complete drive replacement].
