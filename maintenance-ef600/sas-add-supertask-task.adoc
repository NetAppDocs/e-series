...
---
= Add a SAS expansion card to an EF300 or EF600 controller
:experimental:
:icons: font
:imagesdir: ../media/
...
. From the Home page of SANtricity System Manager, select menu:Storage[Operations in Progress]. Wait for all operations to complete before continuing with the next step.
