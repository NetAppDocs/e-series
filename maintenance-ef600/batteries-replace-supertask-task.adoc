...
summary: Replace a battery in an EF300 or EF600 array.
---
= Replace the battery in an EF300 or EF600 array
:experimental:
:icons: font
:imagesdir: ../media/

[.lead]
You can replace a battery in an EF300, EF600, EF300C, or EF600C storage system.
...
. If the controller is not already offline, take it offline now using SANtricity System Manager.
 .. Select menu:Hardware[Controller and components].
...
+
image::../media/batt_2.png["Remove connector housing the battery wiring"]

. Lift the battery out of the controller and place on a flat, static-free surface.
+
image::../media/batt_4.png["Lift battery out of controller"]
...
+
NOTE: To comply with IATA safely regulations, replacement batteries are shipped with a state of charge (SoC) of 30 percent or less. When you reapply power, keep in mind that write caching does not resume until the replacement battery is fully charged and it has completed its initial learn cycle.
...
+
image::../media/batt_5.png["Insert battery"]
+
...
+
image::../media/remove_controller_7.png["Install controller into the shelf"]
...
. Place controller online.
 .. In SANtricity System Manager, select menu:Hardware[Controllers and components].
...
. Click menu:Support[Upgrade Center] to ensure that the latest version of SANtricity OS is installed.
+
