---
permalink: maintenance-ef600/task_add_host_interface_card.html
sidebar: sidebar
keywords: 
summary: ''
---
...
Go to link:task_add_host_interface_card.md#[Remove controller canister]
...
Go to link:task_add_host_interface_card.md#[Add the new host interface card].
...
Go to link:task_add_host_interface_card.md#[Reinstall the controller canister].
...
Go to link:task_add_host_interface_card.md#[Complete adding host interface card].
...
== Complete adding host interface card
