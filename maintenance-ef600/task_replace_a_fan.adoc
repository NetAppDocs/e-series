---
permalink: maintenance-ef600/task_replace_a_fan.html
sidebar: sidebar
keywords: 
summary: ''
---
...
Go to link:task_replace_a_fan.md#[Remove controller canister].
...
Go to link:task_replace_a_fan.md#[Remove failed fan].
...
Go to link:task_replace_a_fan.md#[Install new fan].
...
Go to link:task_replace_a_fan.md#[Reinstall controller canister]
...
Go tolink:task_replace_a_fan.md#[Complete fan replacement].
