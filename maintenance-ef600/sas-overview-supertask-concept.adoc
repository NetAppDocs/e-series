...
---
= SAS expansion card replacement requirements for EF300 and EF600
:icons: font
:imagesdir: ../media/
...
* For EF300 and EF600 controllers, the SAS expansion card must be installed in port 1 to allow for drive tray expansion.
