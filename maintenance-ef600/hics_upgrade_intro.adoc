...
Go to link:hics_upgrade_intro.md#[Remove controller canister]
...
Go to link:hics_upgrade_intro.md#[Remove a host interface card].
...
Go to link:hics_upgrade_intro.md#[Upgrade host interface card].
...
Go to link:hics_upgrade_intro.md#[Reinstall controller canister].
...
Go to link:hics_upgrade_intro.md#[Complete the host interface card upgrade].
