...
+
NOTE: Some S3-compliant accounts may require secured HTTP connections. For information on placing a StorageGRID certificate in the keystore, see link:install_intro_concept.html#add-storagegrid-certificate-into-a-keystore[Add StorageGRID certifcate into a keystore].
