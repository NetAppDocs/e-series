---
permalink: cloud-connector/concept_backups.html
sidebar: sidebar
keywords: 
summary: ''
---
...
+
NOTE: If your filesystem does not appear, verify your filesystem type is supported by the SANtricity Cloud Connector application. For more information, refer to link:concept_learn_about_cloud_connector.md#[Supported file systems].
