...
[.lead]
The SANtricity Web Services Proxy is a RESTful API server installed separately on a host system to manage hundreds of new and legacy NetApp E-Series storage systems.

It includes SANtricity Unified Manager, which is a web-based interface that provides similar functions.
