...
For compatibility information, refer to the link:https://imt.netapp.com/matrix/[Interoperability Matrix Tool^].  Also, see the procedures in the Express Guides for your operating system: 
