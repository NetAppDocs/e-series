...
. If the Resolve Self-Signed Certificates dialog box opens, review the information displayed for the untrusted certificates. For more information, you can also click the ellipsis at the far end of the table and select *View* from the pop-up menu.
. Do one of the following:
