...
keywords: E-Series, eseries, vCenter plugin, Plugin for vCenter, SANtricity plugin for vCenter, VMware vSphere Client, vCenter plugin roles, vCenter plugin user access permissions
summary: Configure access permissions for Plugin for vCenter users.
---
