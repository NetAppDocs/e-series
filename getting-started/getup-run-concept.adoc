...
To install the E-Series hardware, access the Installation and Setup instructions for your storage array and shelf type (if applicable):

[role="quick-margin-list"]
* link:../install-hw-ef50-ef80/install-workflow.html[EF50 or EF80 storage system^]
...
[role="quick-margin-list"]
* https://docs.netapp.com/us-en/e-series-santricity/system-manager/index.html[SANtricity System Manager Online Help for 12.0x^]
* https://docs.netapp.com/us-en/e-series-santricity-119/system-manager/index.html[SANtricity System Manager Online Help for 11.9x^]
