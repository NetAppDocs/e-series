...
a|
Supports up to 24 NVMe SSD in the controller shelf and then a further 96 SAS SSD in SAS expansions shelves, with a single host interface card (HIC) per controller.
a|
Interfaces:
