...
Complete the I/O module replacement by verifying that all volumes have been returned to their preferred owners, collecting support data, and resuming operations.
