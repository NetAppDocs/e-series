...
* The illustration shows the removal of an I/O module from slot 2. Depending on the type of I/O module you are upgrading to, the slot can be different.
...
+
* For SAS expansion shelf cabling, you can use the link:../install-hw-cabling/hotadd-drive-shelf-task.html[Hot-add a drive shelf (E-Series)^] procedure.
