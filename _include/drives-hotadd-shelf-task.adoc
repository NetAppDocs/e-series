...
* Your controllers must already have SAS I/O modules installed; otherwise, you need to first install the SAS I/O modules.
+
See the _Upgrade I/O Modules_ procedure for your storage system model in the _Maintain systems_ section.
...
* To cable the new shelf, you recable the A-side controller-to-shelf connections and shelf-to-shelf connections, verify the A-side path is active, and then recable the B-side controller-to-shelf connections and shelf-to-shelf connections....and verify?
