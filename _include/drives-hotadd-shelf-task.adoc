...
* Your storage system must have available SAS ports. This means SAS I/O modules (cards) must already be installed. If they are not, use the applicable procedure for your storage system model:
+
