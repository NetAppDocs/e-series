...
NOTE: IOM12C modules are only supported on SANtricity OS 11.90R2 onward. Ensure your controller's firmware has been updated before installing or upgrading to an IOM12C.
