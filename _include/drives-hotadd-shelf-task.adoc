...
* Verify that the version of SANtricity your storage system is running supports SA expansion shelves. 
...
This procedure applies to hot adding a DE212C, DE224C, or DE460C drive shelf to an E2800, E2800B, EF280, E5700, E5700B, EF570, EF300, EF600, EF300C, EF600C, or E4000 controller shelf.
