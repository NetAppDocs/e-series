...
+
When you are done cabling the A-side path to the two shelves, the cabling should look like the following:

image::../media/drw_ef50-ef80_2nd_de460c_cabling_hotadd_a-side_ieops-2998.svg[example of cabling for two hot added shelves]
...
+
When you are done cabling the B-side path to the two shelves, the cabling should look like the following:

image::../media/drw_ef50-ef80_2nd_de460c_cabling_hotadd_b-side_ieops-3007.svg[example of cabling for two hot added shelves]

When you are done cabling the two shelves, the cabling should look like the following:
