...
+
NOTE: If you are hot-adding a third shelf to a stack of two shelves, the cabling should look like the illustration in the  link:../install-hw-ef50-ef80/install-cable.html#step-3-cable-the-sas-shelf-connections[when cabling the hardware for a new storage system installation^] section.
+
