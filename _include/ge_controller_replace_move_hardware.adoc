...
== About this task
* You should install the replacement controller within 60 minutes of removing the failed controller to maintain proper cooling for the storage system. 
+
...
// +
// A storage system has three location LEDs: one on the operator display panel and one on each controller. 
