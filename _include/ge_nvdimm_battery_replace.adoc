...
. Unpack the replacement NV battery and set it on a flat static-free surface near the storage system.
+
Save the packing materials to use when returning the faulty NV battery.
