...
. Unpack the replacement RTC battery, and set it on a flat, static-free surface near the storage system.
+
Save all packing materials for use when returning the failed RTC battery.
