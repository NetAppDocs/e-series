...
Prepare for the drive replacement by making sure the drive has failed, confirming you have a supported drive replacement, taking appropriate precautions when handling the drive, and physically locating the failed drive.
...
. If needed, confirm that the replacement drive you have is supported for you storage system configuration:
...
+
. Avoid physical damage to drives during handling and installation of a drive:
+
