...
// Jan 16 I don't see "View operations in progress" as an option the click/choose. The Home page provides an Overview with an IOPS graph (as the default view). Is that the operations in process view...so nothing to click on? 
