...
. Remove the following three steps since I'm moving them to Prepare topics....but make sure that works for all the internal FRUs. I/O module needs a prepare topic? DIMM, RTC etc don't need prepare topics.
