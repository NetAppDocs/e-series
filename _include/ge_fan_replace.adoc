...
. Unpack the replacement fan, and set it on a flat, static-free surface near the storage system.
+
Save the packing materials to use when returning the faulty fan.
