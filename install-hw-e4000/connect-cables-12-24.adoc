---
permalink: install-hw-e4000/connect-cables-12-24.html
sidebar: sidebar
keywords: E4000, connect power cables
summary: Attach the power cables and power on the drive shelves.
---
= Connect the cables (E4012, E4024)
:icons: font
:imagesdir: ../media/
...
.Example A: E4000 controller shelf with three DE212C/DE224 disk shelves in a standard SAS configuration.
+
