...
*insert new graphic here of P1 management port*
...
. In the simplest network configuration, connect your controller to a web browser and use SANtricity System Manager for managing a single E4000 series storage array.
