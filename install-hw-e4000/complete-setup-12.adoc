...
image:../media/drw_e4012_direct_topology_ieops-2047.svg[E4012 Direct Topology, width=500px]
...
image:../media/drw_e4012_fabric_topology_ieops-2046.svg[E4012 Fabric Topology, width=500px]
