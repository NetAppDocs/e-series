...
. Connect each host adapter directly to the host ports 0b1 and 0b2 on the controllers.
...
. Connect each switch directly to the host ports 0b1 and 0b2 on the controllers.
...
+
image:../media/e4000_management_port.png[]
+
E4000 controller Management Port 
