...
image:../media/drw_e4060_direct_topology_ieops-2048.svg[E4060 Direct Topology, width=500px]

. Connect each host adapter directly to the host ports e0a and e0b on the controllers.
...
image:../media/drw_e4060_fabric_topology_ieops-2049.svg[E4060 Fabric Topology, width=500px]
