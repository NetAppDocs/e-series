...
---
= Trays supported in the E-Series 3040 40U cabinet
:icons: font
:imagesdir: ../media/
...
If your controller-drive trays or expansion drive trays are not listed below, see https://hwu.netapp.com[NetApp Hardware Universe^] to verify if your controller-drive trays or expansion drive trays are supported.
