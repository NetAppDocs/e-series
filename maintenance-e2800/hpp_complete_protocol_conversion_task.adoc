...
[.lead]
After converting the protocol of the host ports, you need to perform additional steps before you can use the new protocol. The steps depend on the starting and ending protocols of the baseboard host ports and the HIC ports.
