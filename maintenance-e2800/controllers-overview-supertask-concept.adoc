...
* Access to the storage array's command line interface (CLI). You can download the CLI package from SANtricity System Manager or you can access it from SANtricity Storage Manager.
