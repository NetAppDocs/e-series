---
permalink: maintenance-e2800/task_upgrade_host_interface_cards_hics.html
sidebar: sidebar
keywords: 
summary: ''
---
...
Go to link:task_upgrade_host_interface_cards_hics.md#[Remove a host interface card].
...
Go to link:task_upgrade_host_interface_cards_hics.md#[Install host interface card].
...
Go to link:task_upgrade_host_interface_cards_hics.md#[Reinstall controller canister].
...
Go to link:task_upgrade_host_interface_cards_hics.md#[Complete upgrading a host interface card].
