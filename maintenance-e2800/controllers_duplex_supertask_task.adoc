...
Go to link:controllers_duplex_supertask_task.md#[Remove failed controller (duplex)].
...
Go to link:controllers_duplex_supertask_task.md#[Remove battery].
...
Go to link:controllers_duplex_supertask_task.md#[Remove host interface card].
...
Go to link:controllers_duplex_supertask_task.md#[Install new controller (duplex)].
