---
permalink: maintenance-e2800/drives_12_24_supertask_task.html
sidebar: sidebar
keywords: recovery, guru, santricity, system, manager, monitor, drive, array, drive, fail, attention, lef, hot-swap, i/o, 12-drive, 24-drive, replace, prepare, replace, remove, complete, replacement
...
== Step 1: Prepare to replace drive (12-drive or 24-drive)
...
== Step 2: Remove failed drive (12-drive or 24-drive)
...
* You have reviewed the link:maintenance-e2800/drives_overview_supertask_concept.html[Requirements for handling drives] topic.
...
+
image::../media/drw_drive_latch_maint-e2800.gif[]
...
Go to link:drives_12_24_supertask_task.html[Install new drive (12-drive or 24-drive)].

== Step 3: Install new drive (12-drive or 24-drive)
...
== Step 4: Complete drive replacement (12-drive or 24-drive)
