---
permalink: maintenance-e2800/concept_overview_and_requirements_canisters.html
sidebar: sidebar
keywords: 
summary: ''
---
...
image:../media/legend_icon_01.gif[]Controller shelf with two power supplies (power-fan canisters) below the controller canisters.
...
image::../media/28_dwg_de460c_rear_no_callouts.gif[]
...
image::../media/28_dwg_e2860_de460c_single_fan_canister_no_callouts.gif[]
