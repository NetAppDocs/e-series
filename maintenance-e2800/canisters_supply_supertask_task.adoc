...
[.lead]
Follow these instructions to replace a power supply in an E2800 array with a 12-drive or 24-drive shelf.
...
[.lead]
You remove a failed power supply so you can replace it with a new one.

When you remove a power supply (referred to in SANtricity System Manager as a _power-fan canister_), you turn off power, disconnect the power cord, and slide the part out of the shelf.
...
[.lead]
You install a new power supply to replace the failed one.

When you install a power supply (referred to in SANtricity System Manager as a _power-fan canister_), you slide the part into the shelf, close the cam handle, reconnect the power cord, and reapply power.
