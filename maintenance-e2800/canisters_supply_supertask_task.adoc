...
Go to link:canisters_supply_supertask_task.md#[Remove failed power supply].
...
Go to link:canisters_supply_supertask_task.md#[Install new power supply].
...
Go to link:canisters_supply_supertask_task.md#[Complete power supply replacement].
