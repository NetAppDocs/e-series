...
sidebar: sidebar
keywords: 12-drive, 24-drive, controller, shelf, drive, power, supplies, supply, integrate, fan, power-fan, canister, santricity, system, manager, replace, redundant, source, adequate, cooling
