...
+
* From System Manager:
.. Select menu:Support[Support Center > Diagnostics] under the left panel.
...
.. From the left panel, select menu:Support[Support Center > Diagnostics].
...
. From the home page of SANtricity System Manager, select menu:Storage[Operations in Progress] under the left panel.
