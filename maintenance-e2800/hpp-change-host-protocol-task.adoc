...
. Locate the serial number.
 .. From SANtricity System Manager, select menu:Support[Support Center].
 .. On the *Support Resources* page, scroll to the *View top storage array properties* section.
...
. Confirm the host ports have the protocol you expect.
 .. From SANtricity System Manager, select menu:Hardware[Controller and components].
