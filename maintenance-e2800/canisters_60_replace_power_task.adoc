...
Go to link:canisters_60_replace_power_task.md#[Remove failed power canister].
...
Go to link:canisters_60_replace_power_task.md#[Install new power canister].
...
Go to link:canisters_60_replace_power_task.md#[Complete power canister replacement].
...
. If a failed power canister is still being reported, repeat the steps in link:canisters_60_replace_power_task.md#[Remove failed power canister] and link:canisters_60_replace_power_task.md#[Install new power canister]. If the problem continues to persist, contact technical support.
