...
[.lead]
You remove a failed power canister so you can replace it with a new one.

When you remove a power canister, you turn off power, disconnect the power cord, and slide the component out of the shelf.
...
[.lead]
You install a new power canister to replace the failed one.

When you install a power canister, you slide the component into the shelf, close the cam handle, reconnect the power cord, and reapply power.
