...
== Add second controller requirements
...
== Replace controller requirements
...
* Installed SANtricity Storage Manager on a management station, so you can use the storage array's command line interface (CLI).
+
