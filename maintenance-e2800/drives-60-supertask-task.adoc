...
NOTE: If needed, information on how to replace an E-Series DE460c expansion shelf can be found under the https://kb.netapp.com/on-prem/E-Series/Hardware-KBs/How_to_replace_an_E_Series_DE460c_controller_expansion_shelf[NetApp Knowledge base^].
