---
permalink: maintenance-e2800/task_add_second_controller.html
sidebar: sidebar
keywords: 
summary: ''
---
...
Go to link:task_add_second_controller.md#[Install host interface card].
...
Go to link:task_add_second_controller.md#[Collect support data].
...
Go to link:task_add_second_controller.md#[Set the storage array to duplex].
...
Go to link:task_add_second_controller.md#[Install second controller canister].
...
Go to link:task_add_second_controller.md#[Complete adding a second controller].
