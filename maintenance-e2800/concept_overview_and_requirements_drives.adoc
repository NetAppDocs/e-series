---
permalink: maintenance-e2800/concept_overview_and_requirements_drives.html
sidebar: sidebar
keywords: 
summary: ''
---
...
image::../media/28_dwg_e2824_de224c_drive_numbering.gif[]
...
image:../media/92_dwg_de6600_drawer_with_hdds_no_callouts.gif[] image:../media/28_dwg_2800_controller_attn_led.gif[]
