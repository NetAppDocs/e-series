...
[.lead]
You remove both cable chains so you can remove and replace a failed drive drawer.
...
[.lead]
You remove a failed drive drawer to replace it with a new one.

Removing a drive drawer entails sliding the drawer partially out, recording the locations of the drives, removing the drives, and removing the drive drawer.
