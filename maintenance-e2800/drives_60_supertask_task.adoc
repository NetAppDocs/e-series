...
* Review the drive drawer requirements in link:drives_overview_supertask_concept.html[Requirements for E2800 drive replacement].
 ...
 ** If the power is off, you do not need to issue the CLI command. Go to link:drives_60_supertask_task.html#remove-cable-chains[Remove cable chains].
