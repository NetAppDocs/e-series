 ...
 ** If the power is off, you do not need to issue the CLI command. Go to link:drives_60_supertask_task.html[Remove cable chains].
 ...
 ** If the command succeeds, you do not need to stop host I/O activity. All drives in the drawer are in pools or volume groups with Drawer Loss Protection. Go to link:drives_60_supertask_task.html[Remove cable chains].
+
