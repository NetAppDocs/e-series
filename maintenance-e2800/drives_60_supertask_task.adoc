...
Go to link:drives_60_supertask_task.md#[Remove cable chains].
...
Go to link:drives_60_supertask_task.md#[Remove failed drive drawer (60-drive)].
...
Go to link:drives_60_supertask_task.md#[Install new drive drawer (60-drive)].
...
Go to link:drives_60_supertask_task.md#[Attach cable chains].
...
Go to link:drives_60_supertask_task.md#[Complete drive drawer replacement].
