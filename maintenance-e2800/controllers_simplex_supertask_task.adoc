...
Go to link:controllers_simplex_supertask_task.md#[Remove failed controller (simplex)].
...
Go to link:controllers_simplex_supertask_task.md#[Remove battery (simplex)].
...
Go to link:controllers_simplex_supertask_task.md#[Remove host interface card (simplex)].
...
Go to link:controllers_simplex_supertask_task.md#[Install new controller (simplex)].
...
Go to link:controllers_simplex_supertask_task.md#[Install host interface card (simplex)].
...
Go to link:controllers_simplex_supertask_task.md#[Install new controller canister (simplex)].
...
Go to link:controllers_simplex_supertask_task.md#[Complete controller replacement (simplex)].
