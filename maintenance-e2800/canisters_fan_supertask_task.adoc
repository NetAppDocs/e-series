...
Go to link:canisters_fan_supertask_task.md#[Remove failed power canister and install new one].
...
Go to link:canisters_fan_supertask_task.md#[Complete fan canister replacement].
