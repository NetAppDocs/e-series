...
[.lead]
Follow this procedure to prepare for a battery replacement in the E2800 storage array.
...
* Review link:batteries_overview_requirements_concept.html[Requirements for E2800 battery replacement].
