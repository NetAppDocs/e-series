...
summary: Prepare for battery replacement, following the appropriate steps for a duplex configuration or a simplex configuration.
---
...
If you have a duplex configuration, you must take the affected controller offline or, if you have a simplex configuration, you must stop host I/O operations and power down the controller shelf.
