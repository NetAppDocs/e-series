...
---
= Replace host interface card in E2800
:icons: font
:imagesdir: ../media/

[.lead]
Follow these instructions to replace a host interface card (HIC) that has failed.
...
[.lead]
If you have a simplex configuration, you power down the controller shelf so you can safely remove the failed HIC.

You must back up the configuration and collect support data first. Then, you can stop host I/O operations and power down the controller shelf.
