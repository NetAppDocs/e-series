...
sidebar: sidebar
keywords: replace, canister, type, requirement, overview, power, supply, fan, requirement, replacing
summary: Before you replace a canister, you need to be aware of canister types and requirements.
---
...
[.lead]
Before you replace a canister, you need to be aware of canister types and requirements. Canister types include power supplies, power canisters, and fan canisters.
