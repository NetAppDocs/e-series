...
Go to link:hics_add_supertask_task.md#[Install host interface card].
...
Go to link:hics_add_supertask_task.md#[Reinstall controller canister].
...
Go to link:hics_add_supertask_task.md#[Complete adding a host interface card].
