...
---
= Replace a drive - E2800 (12-drive or 24-drive shelf)
:icons: font
:imagesdir: ../media/
...
. If needed, use SANtricity System Manager to confirm you have a suitable replacement drive.
 .. Select menu:Hardware[Drivess] under the left panel
...
+
image::../media/drw_drive_latch_maint-e2800.gif["Press the release button to remove the failed drive"]
...
NOTE: Perform this operation only when instructed to do so by technical support or the Recovery Guru.
 ...
 .. Select menu:Hardware[Drives] under the left panel
