...
Go to link:controllers_second_add_task.md#[Install host interface card].
...
Go to link:controllers_second_add_task.md#[Collect support data].
...
Go to link:controllers_second_add_task.md#[Set the storage array to duplex].
...
Go to link:controllers_second_add_task.md#[Install second controller canister].
...
Go to link:controllers_second_add_task.md#[Complete adding a second controller].
