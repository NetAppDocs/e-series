...
sidebar: sidebar
keywords: replace, host, interface, card, hic, fail, controller, identical, place, offline, duplex, remove, canister, install, reinstall
...
Go to link:hics_replace_supertask_task.md#[Install host interface card].
...
Go to link:hics_replace_supertask_task.md#[Place controller online (duplex)].
