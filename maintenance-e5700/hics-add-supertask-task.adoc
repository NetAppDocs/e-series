...
---
= Add host interface card (HIC) - E5700
:experimental:
:icons: font
:imagesdir: ../media/
...
+
image::../media/28_dwg_e2800_internal_cache_active_led_maint-e5700.gif["Inernal cache active LED"]
+
...
+
image::../media/28_dwg_e2800_hic_faceplace_screws_maint-e5700.gif["Install HIC onto controller"]
...
. If you installed a HIC with SFP+ (optical) ports, confirm the new ports have the host protocol you expect.
 .. From SANtricity System Manager, select menu:Hardware[Controllers and components].
