...
. If a failed power supply is still being reported, repeat the steps in link:maintenance-e5700/canisters_supply_replace_task.html#remove-power-supply[Remove power supply] and link:maintenance-e5700/canisters_supply_replace_task.html#install-new-power-supply[Install new power supply]. If the problem continues to persist, contact technical support.
