---
permalink: maintenance-e5700/task_replace_controller_in_duplex_configuration.html
sidebar: sidebar
keywords: 
summary: ''
---
...
+
image:../media/legend_icon_01.gif[] MAC address: The MAC address for management port 1 ("`P1`"). If you used DHCP to obtain the original controller's IP address, you need this address to connect to the new controller.
+
...
Go to link:task_replace_controller_in_duplex_configuration.md#[Step 3: Remove host interface card].
...
+
image:../media/legend_icon_01.gif[] Host Link LEDsimage:../media/legend_icon_02.gif[]Attention LED (Amber)image:../media/legend_icon_03.gif[] Seven-segment display
