...
Go to link:batteries_replace_supertask_task.md#[Re-install controller canister].
...
Go to link:batteries_replace_supertask_task.md#[Place controller offline (duplex)].
