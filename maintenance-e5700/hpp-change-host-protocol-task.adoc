...
---
= Change the host protocol - E5700
:experimental:
:icons: font
:imagesdir: ../media/
...
. On the Support Resources page, locate and select the *Storage Array Profile* link.
...
. Locate the serial number.
 .. From SANtricity System Manager, select menu:Support[Support Center].
 .. From the *Support Resources* page, scroll to the *View top storage array properties* section.
