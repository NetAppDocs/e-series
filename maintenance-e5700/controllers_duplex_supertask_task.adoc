...
sidebar: sidebar
keywords: replace, controller, canister, duplex, configuration, two-controller, module, storage, array, battery, hic, install, replacement, prepare, battery, host, interface, card
...
Go to Remove failed controller (duplex).
//link
