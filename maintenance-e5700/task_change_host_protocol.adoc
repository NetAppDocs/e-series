---
permalink: maintenance-e5700/task_change_host_protocol.html
sidebar: sidebar
keywords: 
summary: ''
---
...
+
The green Cache Active LEDimage:../media/legend_icon_01.gif[] on the back of each controller is on when cached data needs to be written to the drives. You must wait for this LED to turn off.image:../media/e5700_ib_hic_w_cache_led_callouts.gif[]
