...
---
= Complete the host protocol conversion - E5700
:experimental:
:icons: font
:imagesdir: ../media/
...
. Click the desired controller and select *Configure iSCSI ports*.
...
NOTE: If you need instructions to add hosts or host clusters, refer to the online help for SANtricity System Manager.
 ...
 .. Select the host to which the port will be associated, and click *Edit Settings*.
+
The dit host settings page appears.

 .. Click *Add Host Port* to associate a new host port identifier to the host.
+
