...
[.lead]
Follow this procedure to replace a drive drawer in an E5700 array.
 ...
 ** If the power is off, you do not need to issue the CLI command. Go to _Step 2: Remove cable chains_.
...
* A location to install each drive.
...
* The new drive drawer installed.
