...
sidebar: sidebar
keywords: upgrade, host, interface, card, hic, port, protocol, storage, array, remove, exist, install, reapply, power, prepare, controller, canister, reinstall, complete, upgrading
...
== Step 6. Complete upgrading a host interface card upgrade
