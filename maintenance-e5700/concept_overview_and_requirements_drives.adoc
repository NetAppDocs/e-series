---
permalink: maintenance-e5700/concept_overview_and_requirements_drives.html
sidebar: sidebar
keywords: 
summary: ''
---
...
[.lead]
You can replace a drive in either a 24-drive or 60-drive controller shelf or drive shelf.
