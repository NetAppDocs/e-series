---
permalink: maintenance-e5700/task_replace_battery.html
sidebar: sidebar
keywords: 
summary: ''
---
...
Go to link:task_replace_battery.md#[Remove failed battery].
...
Go to link:task_replace_battery.md#[Re-install controller canister].
...
Go to link:task_replace_battery.md#[Place controller offline (duplex)].
