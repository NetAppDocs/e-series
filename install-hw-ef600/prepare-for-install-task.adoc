...
---
= Prepare to install your EF300 or EF600 storage system
:icons: font
:imagesdir: ../media/
...
+
NOTE: You can register your system now or later. Later, at system startup, you are prompted to register your system.
+
...
Rack-mount hardware
|===
The following table identifies the types of cables you might receive. If you receive a cable not listed in the table, see link:https://hwu.netapp.com[NetApp Hardware Universe^] to locate the cable and identify its use.
+
[options="header"]
|===
