---
permalink: upgrade-controllers/task_prepare_to_upgrade_controller.html
sidebar: sidebar
keywords: 
...
+
You need this serial number to perform the steps in link:task_complete_controller_upgrade.md#[Complete controller upgrade].
...
Go to link:task_remove_controllers_upgrading.md#[Remove controllers].
