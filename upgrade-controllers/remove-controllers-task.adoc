...
.EF80 and EF50 controller models
--

For information about removing controllers from EF80 and EF50 storage systems, see link:https://docs.netapp.com/us-en/e-series/maintenance-ef50-ef80/controller-replace-move-hardware.html#step-1-remove-the-controller[EF50 and EF80 - Step 1: Remove the controller^].

--

.Other E-Series controller models
--

[discrete]
=== E4000, E2800, and E5700 controller models
...
[discrete]
=== EF600 and EF300 controller models

Remove the controller canister so you can replace it with a new one.
...
+
Because you must remove the HIC from the old controller canister, you must remove any SFPs from the HIC ports. When you reconnect the cables, you can move those SFPs to the new controller canister.
