...
For information about installing new EF80 and EF50 controllers, see link:https://docs.netapp.com/us-en/e-series/maintenance-ef50-ef80/controller-replace-move-hardware.html#step-7-install-the-controller[EF50 and EF80 - Step 7: Install the controller^].
