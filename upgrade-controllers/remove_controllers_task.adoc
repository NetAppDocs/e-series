...
If you intend to use the battery from the old controller in the new controller, go to the next part of the section; otherwise go to link:upgrade-controllers/install_controllers_task.html[Install new controllers].
...
Go to link:upgrade-controllers/install_controllers_task.html[Install new controllers].
