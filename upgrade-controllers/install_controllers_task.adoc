...
Go to link:install_controllers_task.md#[Step 2: Install new controller canister].
...
Go to link:complete_upgrade_controllers_task.md#[Complete controller upgrade].
