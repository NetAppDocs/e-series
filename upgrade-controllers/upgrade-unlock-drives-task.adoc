...
+
*Example:* `SMcli <original_controller _ip> -u admin -p "<original_array_password>" -c "create storageArray securityKey keyIdentifier=\"keyIdentifierString\" passPhrase=\"passPhraseString\" file=\"filename\";”`