...
NOTE: When upgrading from EF300 to EF50 or EF80, you must configure the host port protocol through the SANtricity System Manager user interface. For more information, see https://docs.netapp.com/us-en/e-series//maintenance-ef50-ef80/io-module-change-protocol.html[Change the host I/O module protocol - EF50 and EF80].
...
+
NOTE: When upgrading from EF600 to EF80, you must configure the host port protocol through the SANtricity System Manager user interface. For more information, see https://docs.netapp.com/us-en/e-series//maintenance-ef50-ef80/io-module-change-protocol.html[Change the host I/O module protocol - EF50 and EF80].
