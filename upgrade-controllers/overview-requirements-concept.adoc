...
+
* EF50 and EF80 support dual-100Gbe NVMe over RoCE host interface cards
+
...
+
* EF50 and do not support Remote Storage Volumes
+
...
+
* EF80 support dual-100Gbe NVMe over RoCE host interface cards
+
