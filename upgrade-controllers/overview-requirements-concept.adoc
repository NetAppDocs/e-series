...
+
Both the EF80 and EF50 systems use high-speed 200GbE external connections to enable inter-controller communication between the two controllers. Each controller is equipped with a dedicated interface card installed in slot 4. This card provides two ports and includes two 0.5m 200GbE cables with the system. 
...
+
NOTE: It is crucial to connect the cables exactly as described.
