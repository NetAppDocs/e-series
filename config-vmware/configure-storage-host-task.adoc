...
. For instructions on creating VMFS datastores or using volumes as RDMs with either the vSphere Client or the vSphere Web Client, see the https://www.vmware.com/support/pubs/[VMware Documentation web site^].
