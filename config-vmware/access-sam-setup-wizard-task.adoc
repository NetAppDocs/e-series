...
sidebar: sidebar
keywords: access System Manager vmware, express vmware configuration, software configuration, vmware host, E2800, E5700, EF300, EF600, EF50, EF80, E4000, E-Series, eseries
summary: You use the Setup wizard in SANtricity System Manager to configure your storage array.
---
= Configure your storage using SANtricity System Manager - VMware
:experimental:
:icons: font
:imagesdir: ../media/
