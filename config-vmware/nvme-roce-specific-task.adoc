...
[options="header"]
|===
| Callout No.| Host (initiator) port connections| Notes
a|
1
a|
Host NQN
...
[options="header"]
|===
| Callout No.| Array controller (target) port connections| Notes
a|
2
a|
Array NQN
...
a|
NVMe over RoCE network port IP address subnet 1
...
a|
NVMe over RoCE network port IP address subnet 2
a|
