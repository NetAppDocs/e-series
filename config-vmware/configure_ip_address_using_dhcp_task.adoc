---
permalink: config-vmware/configure_ip_address_using_dhcp_task.html
sidebar: sidebar
keywords: express, method, configuring, configure, communication, management, station, storage, array, dynamic, host, configuration, protocol, dhcp, ip, address, controller, simplex, duplex, port, management
