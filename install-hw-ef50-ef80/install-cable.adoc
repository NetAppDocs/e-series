...
--
Cable each controller to each IOM12 module on the DE460C shelf. 
...
+
image:../media/drw_ef50-ef80_3_de460c_cabling_ieops-xxxx.svg[cable controllers to de460c shelves 1 and 3]
