...
After cabling the inter-controller mirroring and host connections for your storage system, link:install-power-hardware.html[power on your storage system].