...
Cable the controllers to each other to enable mirroring. The cabling is the same for EF50 and EF80 storage systems.

NOTE: No matter the speed of the mirroring I/O modules installed in your storage system, you use the included 200 GbE cables. If the speed of the mirroring I/O modules is 100 GbE, the connection operates at the lower speed.

// Dec 17 fdbk: AE - The cables that are included in the box for mirroring are 200Gb speed cables. The EF80 has a choice of either a 100Gb or 200Gb mirroring card, and the EF50 only has 100Gb, but the cables included are all 200Gb capable no matter the card speed. I'm not sure how we would want to specify this difference or this consideration in the documentation. I'm trying to think of how best we can relay to the customer the speed and how it will work with 200Gb connectivity as well.
