...
NOTE: No matter the speed of the mirroring I/O modules installed in your storage system, you use the included 200 GbE cables for the mirroring connections.
