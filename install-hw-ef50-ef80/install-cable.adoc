...
* You always cable the controllers and one or more shelves so that there are two cable connections for the A-side path (IOMA) and a B-side path (IOMB), as shown in the cabling illustrations.
