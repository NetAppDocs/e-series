...
sidebar: sidebar
keywords: 
summary: Cable and configure the controller management port on each controller for out-of-band storage system management, and then configure your EF50 or EF80 storage system.
---
...
[.lead]
Cable and configure the controller management port on each controller for out-of-band storage system management, and then configure your EF50 or EF80 storage system.
