...
== Step 3: Verify the protocol on the host I/O modules is correct
...
. Check to see the default protocol being used by the type of host I/O modules on your storage system by using SANtricity System Manager.

.. SAM

.. SAM

. If you verifies your storage system is running the host protocol you want, no further action is needed.

. If the default protocol is not the protocol you want, change it using the link:io-module-change-protocol.html[Change the host protocol] procedure.
