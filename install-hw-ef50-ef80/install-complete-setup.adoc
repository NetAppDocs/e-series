...
sidebar: sidebar
keywords: 
summary: Cable and configure the management port on each controller for out-of-band storage system management, and then configure your EF50 or EF80 storage system.
---
...
[.lead]
Cable and configure the management port on each controller for out-of-band storage system management, and then configure your EF50 or EF80 storage system.
...
== Step 3: Verify host I/O module protocol is correct
...
. Verify the default protocol being used on the host I/O modules in your storage system by using SANtricity System Manager.
...
a|You need to change it using the link:io-module-change-protocol.html[Change the host protocol] procedure.
