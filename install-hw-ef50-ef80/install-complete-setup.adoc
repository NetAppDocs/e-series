...
== Step 3: Check that the protocol on the host I/O modules is correct
...
Lisa, Since R.1 and 2 add more protocol and HIC support, I'd have to update this table. I prefer users go to SAM to see/confirm the protocol on their system.
...
. Check to see the default protocol being used by the type of host I/O modules on your storage system.
+
