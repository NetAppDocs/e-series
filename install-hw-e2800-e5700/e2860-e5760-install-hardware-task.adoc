...
---
= Install the hardware for E2860, E5760, and DE460
:icons: font
:imagesdir: ../media/
...
. Install the shelf.
+
CAUTION: An empty shelf weighs approximately 134 lb (61 kg). A mechanized lift or four people using lift handles are required to safely move an empty shelf.
+
