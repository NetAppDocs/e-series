...
---
= Complete storage system setup and configuration for E2860, E5760, and DE460
:icons: font
:imagesdir: ../media/
...
|===
a|
image:../media/4U_DirectTopology.png["Direct-attach topology cabling"] a|
...
|===
a|
image:../media/4U_FabricTopology.png["Fabrix topology cabling"] a|
...
|===
a|
image:../media/cable_ethernet_inst-hw-e2800-e5700.png["Ethernet cables"] a|
...
|===
a|
image:../media/e2800_mgmt_ports.png["E2800 management ports"]
