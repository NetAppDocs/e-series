...
---
= Installation and setup workflow for E2800 and E5700 storage systems
:icons: font
:imagesdir: ../media/
...
NOTE: The E2800 and E5700 storage systems are end-of-availability (EOA) products and are no longer available for purchase, but still supported. The information in this section is provided for reference only.
