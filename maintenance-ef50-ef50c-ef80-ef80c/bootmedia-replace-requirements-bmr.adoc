---
permalink: maintenance-ef50-ef50c-ef80-ef80c/bootmedia-replace-requirements-bmr.html
sidebar: sidebar
...
---
= Requirements for automated boot media recovery - EF50, EF50C, EF80, and EF80C
:icons: font
:imagesdir: ../media/
