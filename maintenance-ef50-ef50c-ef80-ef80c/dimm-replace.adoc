...
[.lead]
Replace a DIMM in your EF50, EF50C, EF80, or EF80C storage system when a memory mismatch is present, or you have a failed DIMM. The replacement process involves shutting down the impaired controller, removing it, replacing the DIMM, reinstalling the controller, and then returning the failed part to NetApp.
